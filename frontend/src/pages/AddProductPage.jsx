      ...
      <AdminLayout>
        <div className="form-page-wrapper">
          <div className="form-page-header">
            <p className="form-page-eyebrow">Catalogue</p>
            <h1 className="form-page-title">Add New Product</h1>
            <p className="form-page-subtitle">Expand your collection with a new piece</p>
          </div>
            ...
            <form className="product-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group full image-field">
                ...
                <div className="image-upload-shell">
                  <div className="image-preview-panel">
                    {previews.length > 0 ? (
                      <img
                        src={previews[showcaseImageIndex] || previews[0]}
                  ...
                  <div className="image-upload-panel">
                    <div>
                      <p className="image-upload-title">Choose a product image</p>
                      <p className="image-upload-copy">
                        Upload multiple images, then choose one image for the collection grid and homepage showcase.
                      </p>
                    </div>

                    <div className="image-actions">
                      <label className="btn-file" htmlFor="product-image">
                    ...
                    {images.length > 0 && (
                      <p className="selected-file">
                        {images.length} image{images.length !== 1 ? "s" : ""} selected. Active image is used for showcase.
                      </p>
                    )}
              ...
              <div className="form-group full">
                ...
                <textarea
                  ...
                  placeholder="Describe this product — materials, inspiration, care instructions…"
                  value={description}
              ...
              <div className="form-group full">
                <label className="showcase-toggle-row">
                  ...
                  <span className="showcase-toggle-text">
                    ...
                    <span className="showcase-toggle-copy">
                      This product will only appear in the homepage slideshow after it is published and has an image.
                    </span>
                  </span>
                </label>
              </div>
